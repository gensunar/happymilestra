import styles from "./RoundTripFlight.module.scss";
...
const RoundTripFlight = () => {
  ...
  const [returnDateIsTouched, setReturnDateIsTouched] = useState(false);
  const [returnDateHasError, setReturnDateHasError] = useState(false);
  const [returnDateErrorMsg, setReturnDateErrorMsg] = useState("");
  ...
  const returnDateChangeHandler = (event) => {
    ...
    setReturnDateIsTouched(true);
    setReturnDateHasError(false);
    setReturnDateErrorMsg("");
  };
  ...
  const submitFormHandler = async () => {
    ...
    if (!returnDate) {
      setReturnDateHasError(true);
      setReturnDateErrorMsg("* Return Date not selected");
      setIsLoading(false);
      return;
    }
    ...
    formData.append("tripType", "Round Trip");
